...
namespace kmgiasoc.Web
{
    ...
    public class kmgiasocWebModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    typeof(kmgiasocResource),
                    typeof(kmgiasocDomainModule).Assembly,
                    typeof(kmgiasocDomainSharedModule).Assembly,
                    typeof(kmgiasocApplicationModule).Assembly,
                    typeof(kmgiasocApplicationContractsModule).Assembly,
                    typeof(kmgiasocWebModule).Assembly
                );
            });
        }
        ...
        private void ConfigureAutoMapper()
        {
            ...
            {
                options.AddMaps<kmgiasocWebModule>();
            });
        }
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<kmgiasocDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}kmgiasoc.Domain.Shared"));
        ...
        private void ConfigureNavigationServices()
        {
            ...
            {
                options.MenuContributors.Add(new kmgiasocMenuContributor());
            });
        }
        ...
        private void ConfigureSwaggerServices(IServiceCollection services)
        {
            services.AddAbpSwaggerGen(
                options =>
                {
                    options.SwaggerDoc("v1", new OpenApiInfo { Title = "kmgiasoc API", Version = "v1" });
        ...
        public override void OnApplicationInitialization(ApplicationInitializationContext context)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "kmgiasoc API");
            });
            app.UseAuditing();
